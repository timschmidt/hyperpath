...
pub use routing::{
    AccelerationLimitedFeedProfileClass, AccelerationLimitedFeedTimeReport,
    AffineSpanAxisProjection, AxisMotionLimits, AxisProjectedMotionLimitsReport,
    AxisProjectionBottleneck, AxisProjectionRowReport, ConstantFeedTimeReport,
    CornerLookaheadJoinClass, CornerLookaheadJoinReport, CornerLookaheadLimitReport,
    DifferentialPairSkewReport, FeedPathElement, JerkFeasibleNodeComponent,
    JerkLimitedFeedTimeReport, JerkRampElementPhaseReport, JerkRampFeedScheduleReport,
    JerkRampPhaseProposal, JerkRampPhaseReport, JerkRampSpanProposal, JerkRampSpanReport,
    KeepoutAwareDetourMeander, LengthMatchProblem, LookaheadFeedPlanningLimits,
    LookaheadFeedSchedule, LookaheadFeedScheduleReport, LookaheadSpanTransitionReport,
    MeanderCandidatePlacementReport, MeanderError, MeanderKeepout,
    ...
    obstacle_aware_detour_meander, plan_axis_projected_motion_limits,
