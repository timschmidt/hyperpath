...
fn main() -> Result<(), String> {
    ...
    .map_err(|error| format!("segment construction failed: {error:?}"))?;
    ...
    let swept = SweptLineSegment::new(centerline, Real::from(1), PredicatePolicy::STRICT)?;
    let _trace = PcbTrace::new(NetId(1), TraceLayer(0), swept, PredicatePolicy::STRICT);
    Ok(())
}
```
<!-- quickstart:end -->
