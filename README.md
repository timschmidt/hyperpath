...
- Mesh-boolean handoff types extrude retained rectangular path/CAM footprints,
  ...
  difference programs, fold multi-source boolean chains, mixed-operation boolean programs,
...
- retained CAM stock/cutter rest-material mesh-boolean programs and strictly
  convex/simple orthogonal polygon prism sources plus holed orthogonal
