...
pub enum PathMeshBooleanSource {
    ...
    /// Simple hole-free straight-edge polygonal prism.
...
impl From<SimplePolygonPrism> for PathMeshBooleanSource {
    fn from(value: SimplePolygonPrism) -> Self {
        Self::SimplePolygonPrism(value)
    }
}
